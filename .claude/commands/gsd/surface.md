...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/GitProject/CH32V303CBT/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/GitProject/CH32V303CBT/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/GitProject/CH32V303CBT/.claude/commands/gsd
AGENTS_DIR=C:/GitProject/CH32V303CBT/.claude/agents
```
...
<execution_context>
Surface state file: `C:/GitProject/CH32V303CBT/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/GitProject/CH32V303CBT/.claude/skills/.gsd-profile`
Engine module: `C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
