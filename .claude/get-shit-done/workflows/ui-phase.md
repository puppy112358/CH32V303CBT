...
```markdown
Read C:/GitProject/CH32V303CBT/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/GitProject/CH32V303CBT/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/GitProject/CH32V303CBT/.claude/agents/gsd-ui-checker.md for instructions.
