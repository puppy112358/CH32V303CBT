...
```bash
INIT=$(node "C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/GitProject/CH32V303CBT/.claude/get-shit-done/templates/spec.md.
