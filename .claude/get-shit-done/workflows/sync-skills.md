...
INSTALL_JS_GLOBAL="C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
