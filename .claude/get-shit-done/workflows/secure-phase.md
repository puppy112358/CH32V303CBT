...
```
Agent(
  prompt="Read C:/GitProject/CH32V303CBT/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/GitProject/CH32V303CBT/.claude/get-shit-done/templates/SECURITY.md`
