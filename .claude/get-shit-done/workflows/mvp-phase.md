...
<required_reading>
@C:/GitProject/CH32V303CBT/.claude/get-shit-done/references/user-story-template.md
@C:/GitProject/CH32V303CBT/.claude/get-shit-done/references/spidr-splitting.md
@C:/GitProject/CH32V303CBT/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/GitProject/CH32V303CBT/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/GitProject/CH32V303CBT/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/GitProject/CH32V303CBT/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
