...
```bash
INIT=$(node "C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/GitProject/CH32V303CBT/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
